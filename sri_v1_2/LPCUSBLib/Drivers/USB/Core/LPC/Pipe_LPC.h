 ...
 *  \defgroup Group_PipeRW_LPC Pipe Data Reading and Writing (LPC)
 *  \brief Pipe data read/write definitions for the Atmel LPC architecture.
 *
 *  Functions, macros, variables, enums and types related to data reading and writing from and to pipes.
 */

/** \ingroup Group_PipePrimitiveRW
 *  \defgroup Group_PipePrimitiveRW_LPC Read/Write of Primitive Data Types (LPC)
 *  \brief Pipe primitive data read/write definitions for the Atmel LPC architecture.
 *
 ...
 *  \defgroup Group_PipePacketManagement_LPC Pipe Packet Management (LPC)
 *  \brief Pipe packet management definitions for the Atmel LPC architecture.
 *
 *  Functions, macros, variables, enums and types related to packet management of pipes.
 */

/** \ingroup Group_PipeControlReq
 *  \defgroup Group_PipeControlReq_LPC Pipe Control Request Management (LPC)
 *  \brief Pipe control request management definitions for the Atmel LPC architecture.
 *
 ...
 *  \defgroup Group_PipeManagement_LPC Pipe Management (LPC)
 *  \brief Pipe management definitions for the Atmel LPC architecture.
 *
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			typedef struct {
				...
				uint16_t BufferSize;
				uint16_t StartIdx;
				uint16_t ByteTransfered;
				uint8_t  EndponitAddress;	/* with direction */
			} USB_Pipe_Data_t;
...
//			static inline bool Pipe_IsINReceived(void) ATTR_WARN_UNUSED_RESULT ATTR_ALWAYS_INLINE;
			 ...
			 *
			 *  \ingroup Group_PipePrimitiveRW_LPC
			 *
